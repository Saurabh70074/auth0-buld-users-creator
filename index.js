...
app.post('/upload-users', async (req, res) => {
  try {
    ...
    for (const user of matchedUsers) {
      ...
      const userId = user.user_id;  // Assuming `user` object has a `user_id` property
...
`
        ...
        // Optional: Send Password Reset Email (you can enable this section later)
        // const passwordResetMailOptions = {
        //   from: process.env.EMAIL_USER,
        //   to: userEmail,
        //   subject: 'Password Reset Request',
        //   text: `Click the link to reset your password: ${passwordResetUrl}`,
        //   html: `<p>Click the link to reset your password: <a href="${passwordResetUrl}">Reset Password</a></p>`,
        // };
        // await transporter.sendMail(passwordResetMailOptions);
        // console.log(`Password reset email sent to: ${userEmail}, ticket URL: ${passwordResetUrl}`);
      } catch (error) {
